...
di utilizzare. Una volta aperta la pagina con il progetto, sarà sufficiente scaricare il progetto in formato ZIP o clonarlo tramite GIT.

Di seguito un esempio di comando GIT CLONE:

```shell
git clone --branch {nome-branch} https://github.com/Kasui92/gdr-stack [OPZ: cartella in cui salvare lo stack]
```
